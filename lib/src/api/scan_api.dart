...
class ScanApi {
  ...
  ///
  Future<BarcodeResponseList> scanBase64PostV4(
  ...
  ///
  Future<BarcodeResponseList> scanFormPostV4(Uint8List fileBytes) async {
    // ignore: prefer_final_locals
    Object? postBody;
  ...
  ///
  Future<BarcodeResponseList> scanGetV4(String fileUrl) async {
    // ignore: prefer_final_locals
    Object? postBody;
